...
public class ReaderPreferences extends PreferenceActivity /*implements OnSharedPreferenceChangeListener*/ {
...
/*    @Override
	...
	/*ReaderDriver MyReader;
	CheckBox checkRX;
	CheckBox checkRF;
	Button readerRegistersButton;
	Button menuButton;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		checkRX.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			...
			public void onCheckedChanged(CompoundButton buttonView,	boolean isChecked){
				RXcheckBoxHandler(buttonView, isChecked);
			}
		});
		...
		checkRF.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			@Override
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				RFcheckBoxHandler(buttonView, isChecked);
			}
		});
	}
	...
	public void RXcheckBoxHandler(View v, boolean isChecked){
		...
		// we want to send back to the first activity
		Intent answerRX = new Intent();
	...
	public void RFcheckBoxHandler(View v, boolean isChecked) {
		...
		// Create an intent object to store the data
		// we want to send back to the first activity
		Intent answerRF = new Intent();
		// Depending on which radio button was chosen
		// we put in different data into the intent object
		answerRF.putExtra("label", R.id.RFonoff_check);
		answerRF.putExtra("ischecked", MyReader.getRF());
			
		// Signal that we have indeed a valid return object
		// by setting the activity result to RESULT_OK
		setResult(RESULT_OK, answerRF);
	...
	public void readerRegistersButtonClickHandler(View v) {
		// Create new intent object and tell it to call the ReaderRegistersList class
    	Intent i = new Intent(this, de.unierlangen.like.rfid.uhf.ReaderRegistersList.class);
    	// Start ReaderRegistersList as a new activity 
    	startActivity(i);
		
	}
	
	// This code below will be execute after clicking on the Menu button  
	// In our case see above
	public void menuButtonClickHandler(View v){
		// Create new intent object and tell it to call the Menu class
		Intent i = new Intent(this, de.unierlangen.like.rfid.uhf.Menu.class);
		// Start Menu as a new activity 
		startActivity(i);
	}*/
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.your_location:
			...
			break;
		default: this.showMsg((String)item.getTitle());
