...
public class SerialPortPreferences extends PreferenceActivity implements
    ...
    protected void onResume() {
        ...
        // usbHost.setSummary(sharedPreferences.getBoolean(key, false) ?
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(KEY_DEVICES_PREFERENCE)) {
            ...
            usbHost.setSummary(sharedPreferences.getBoolean(key, false) ? "Disable this setting"
                    : "Enable this setting");
        }
