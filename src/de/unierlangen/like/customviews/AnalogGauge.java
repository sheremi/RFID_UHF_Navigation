...
public final class AnalogGauge extends View {
	...
	/** int sweepAngle represents angle between min and max. Should be less than 270 */
	 ...
	 * @param value Value to indicate. Usually from 0 to 100
	 */
	...
	private void drawScale(Canvas canvas) {
		...
		//Okay, here we go
		/** Angle=0 is 3 o'clock. -90 offset for 12 o'clock and half-a-sweepAngle to get to
		 * position, which corresponds with minValue. */
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (MeasureSpec.getMode(widthMeasureSpec) == MeasureSpec.UNSPECIFIED) {widthSize=300;}
